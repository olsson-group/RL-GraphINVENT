...
def evaluate_generated_graphs(generated_graphs, termination, agent_lls, prior_lls, start_time,
    ...
    prop_dict[(epoch_key, "agent_lls")] = agent_lls
    prop_dict[(epoch_key, "prior_lls")] = prior_lls
    ...
    fraction_valid, validity_tensor, smiles = util.write_molecules(molecules=generated_graphs,
                                                                   agent_lls=agent_lls,
                                                                   prior_lls=prior_lls,
                                                                   epoch=epoch_id)
